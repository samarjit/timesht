	...
	<xsl:template name="DefinitionsTemplate" match="//bpmnxmi:Definitions">
		<bpmn:definitions>
			...
			<xsl:for-each select="relationships">
				...
				</bpmn:relationship><br/>
			</xsl:for-each>
		</bpmn:definitions>
	</xsl:template>

	<xsl:template name="BPMNPlaneTemplate">
	BPMNPlaneTemplate	<xsl:call-template name="PlaneTemplate" />
...
BPMNShapeTemplate		<xsl:call-template name="LabeledShapeTemplate" />
		<xsl:if test="@bpmnElement">
			<xsl:attribute name="bpmnElement"> <xsl:value-of select="@bpmnElement" /> </xsl:attribute>
		</xsl:if>
...
<br/>
	...
	BPMNLabelTemplate	<xsl:call-template name="LabelTemplate" />
	...
	BPMNEdgeTemplate	<xsl:call-template name="LabeledEdgeTemplate" />
		<xsl:if test="@bpmnElement">
			<xsl:attribute name="bpmnElement"> <xsl:value-of select="@bpmnElement" /> </xsl:attribute>
		</xsl:if>
...
BPMNDiagramTemplate		<xsl:call-template name="DiagramTemplate" />
...
DiagramTemplate		<xsl:if test="@name">
			<xsl:attribute name="name"> <xsl:value-of select="@name" /> </xsl:attribute>
		</xsl:if>
	...
	NodeTemplate	<xsl:call-template name="DiagramElementTemplate" /> <br/>
	</xsl:template>

	<xsl:template name="EdgeTemplate">
EdgeTemplate		<xsl:call-template name="DiagramElementTemplate" />
...
ShapeTemplate		<xsl:call-template name="NodeTemplate" />
...
PlaneTemplate		<xsl:call-template name="NodeTemplate" />
