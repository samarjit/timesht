 ...
 */
public class StatelessSplitInstance extends StatelessNodeInstanceImpl {
            ...
            case Split.TYPE_XOR :
                ...
                for ( final Iterator<Connection> iterator = outgoing.iterator(); iterator.hasNext(); ) {
                    ...
                    if ( constraint != null && constraint.getPriority() < priority && !constraint.isDefault()) {
                        System.out.println("StatelessSplit Instance:Trying to evaluate XOR constraint...");
            ...
            case Split.TYPE_XAND :
                ...
                if (connections == null || connections.isEmpty()) {
        	        ...
        	        for (Map.Entry<NodeInstance, String> entry: nodeInstances.entrySet()) {
        	        	...
        	        	if (!hidden) {
        	        		StatelessRuntime.eINSTANCE.getEventSupport().fireBeforeNodeLeft(this, null/*kruntime*/);
        	        	}
        	            ((org.jbpm.workflow.instance.NodeInstance) entry.getKey())
        	        		.trigger(this, entry.getValue());
        	            if (!hidden) {
        	            	StatelessRuntime.eINSTANCE.getEventSupport().fireAfterNodeLeft(this, null/*kruntime*/);
        	            }
        	        }
                }
                break;
